...
const DATA_URL =
	'https://raw.githubusercontent.com/melchiorhering/melchiorhering.github.io/main/src/leaderboard/teams.json'
...
const Hero = () => {
	...
	return (
		<section className='py-16 text-center text-white bg-gray-800'>
			<img src='/hero-image.jpg' alt='Hero Image' className='w-32 mx-auto mb-4 rounded-full' />
